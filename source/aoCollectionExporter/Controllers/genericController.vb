...
Namespace Contensive.Addons.aoCollectionExporter.Controllers
    Public NotInheritable Class genericController
        Private Sub New()
        End Sub
        '
        Friend Shared Function buildVersion(cp As CPBaseClass) As String
            Return cp.Site.GetText("BUILDVERSION")
        End Function
        '
        '====================================================================================================
        ''' <summary>
