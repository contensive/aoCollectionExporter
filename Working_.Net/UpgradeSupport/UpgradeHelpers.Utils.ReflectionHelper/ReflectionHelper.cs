...
namespace UpgradeHelpers.Helpers
{
    ...
    public class ReflectionHelper
    {
        ...
        public static void SetPrimitiveValue(ref System.Windows.Forms.Control ctl, object propertyValue, params object[] index)
        {
            object obj = ctl;
        ...
        {
#if WINFORMS
            return (type == null || type.IsPrimitive || type.IsEnum || (type.FullName == "System.String") || (type.FullName == "System.Object") || (type.FullName == "System.Drawing.Color") || (type.FullName == "System.Windows.Forms.Cursor"));
#else
            return (type == null || type.IsPrimitive || type.IsEnum || (type.FullName == "System.String") || (type.FullName == "System.Object") || (type.FullName == "System.Windows.Media.Color") || (type.FullName == "System.Windows.Input.Cursor"));
#endif
        }
        ...
        private static bool IsIntrinsic(Type type)
        {
            ...
            return _defaultProps.ContainsKey(type.FullName) ||
                   _defaultProps.ContainsKey(type.FullName + ".Get") ||
                   _defaultProps.ContainsKey(type.FullName + ".Set");
        }
        ...
        {
            if (_defaultProps.ContainsKey(type.FullName))
                return ObtainProperty(type, _defaultProps[type.FullName]);
            return ObtainProperty(type, _defaultProps[type.FullName] + (theSetProperty ? ".Set" : ".Get"));
        }
        ...
        private static System.Windows.Forms.Cursor GetValueForcedToCursor(object propertyValue)
        {
            Type sourceType = GetPropertyValueType(propertyValue);
            ...
            {
                case 0: return System.Windows.Forms.Cursors.Default;
                ...
                case 13: return System.Windows.Forms.Cursors.WaitCursor;
                case 14: return System.Windows.Forms.Cursors.Help;
                case 15: return System.Windows.Forms.Cursors.SizeAll;
                default: return (System.Windows.Forms.Cursor)propertyValue;
            }
        }
#endif
